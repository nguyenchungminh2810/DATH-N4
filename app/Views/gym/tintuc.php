        ...
        <form class="needs-validation mr-15" style="margin-bottom: 30px;" novalidate>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" placeholder="SomeThing"  required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom02" placeholder="SomeThing"  required>
                    <div class="invalid-feedback">
                        Vui Lòng Nhập Thông Tin!
                    </div>
                </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="EditTT"><button class="btn btn-primary">Sửa</button></a>
