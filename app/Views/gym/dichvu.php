    ...
    <div class="page projects-page" style="margin-top: 10%">
        <form class="needs-validation mr-15" style="margin-bottom: 30px;" novalidate>
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    <label for="validationCustom02">Giới Thiệu</label>
                ...
                <div class="col-md-3 mb-3">
                    <label for="validationCustom02">Lợi Ích</label>
                    <input type="text" class="form-control" id="validationCustom02" placeholder="SomeThing"
                           required>
                    <div class="invalid-feedback">
                        Vui Lòng Nhập Thông Tin!
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="validationCustomUsername"
                               placeholder="Image" aria-describedby="inputGroupPrepend" required>
                        <div class="invalid-feedback">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="EditDV"><button class="btn btn-primary">Sửa</button></a>
